...
function Form_b() {
    return(
        <form className="form" method="POST" action="/pat_up">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col">
                        <h1 className="display-1">UPDATE PATIENT</h1>
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            <label htmlFor="exampleInputEmail1" className="form-label">New Blood Pressure</label>
                            <input type="text" className="form-control" id="bp" aria-describedby="emailHelp" name="blood"/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleInputEmail1" className="form-label">New BMI (Body Mass Index)</label>
